...
def load_pretrained(config, model, logger):
    logger.info(f"==============> Loading weight {config['pretrained']} for fine-tuning......")
    ...
    state_dict = {k: v for k, v in state_dict.items() if 'head.weight' not in k and 'head.bias' not in k}
