...
class CANet(nn.Module):
    def __init__(self, bit,nclass,model_name="resnet50"):
        super().__init__()
        self.code_length = bit
        self.classlen = nclass
        bits = self.code_length
        classlen = self.classlen
    ...
    def forward_vanilla(self, x):
        ...
        return f11, f22 , f33 , y33, feats

    def get_features_params(self):
        return list(self.backbone.parameters())

    def train(self, mode=True):
        super(CANet, self).train(mode)
