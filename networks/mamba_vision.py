...
from mamba_ssm.ops.selective_scan_interface import selective_scan_fn  # pip install mamba-ssm
...
default_cfgs = {
    "mamba_vision_T": _cfg(
        url=base_url + "/nvidia/MambaVision-T-1K/resolve/main/mambavision_tiny_1k.pth.tar",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "mamba_vision_T2": _cfg(
        url=base_url + "/nvidia/MambaVision-T2-1K/resolve/main/mambavision_tiny2_1k.pth.tar",
        crop_pct=0.98,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "mamba_vision_S": _cfg(
        url=base_url + "/nvidia/MambaVision-S-1K/resolve/main/mambavision_small_1k.pth.tar",
        crop_pct=0.93,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "mamba_vision_B": _cfg(
        url=base_url + "/nvidia/MambaVision-B-1K/resolve/main/mambavision_base_1k.pth.tar",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "mamba_vision_L": _cfg(
        url=base_url + "/nvidia/MambaVision-L-1K/resolve/main/mambavision_large_1k.pth.tar",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
    "mamba_vision_L2": _cfg(
        url=base_url + "/nvidia/MambaVision-L2-1K/resolve/main/mambavision_large2_1k.pth.tar",
        crop_pct=1.0,
        input_size=(3, 224, 224),
        crop_mode="center",
    ),
...
def mamba_vision_B(pretrained=False, **kwargs):
    model_path = kwargs.pop("model_path", f"{Path.home()}/.cache/huggingface/hub/mambavision_base_1k.pth.tar")
    ...
    pretrained_cfg = default_cfgs["mamba_vision_B"]
    model = MambaVision(
        depths=depths,
        num_heads=num_heads,
